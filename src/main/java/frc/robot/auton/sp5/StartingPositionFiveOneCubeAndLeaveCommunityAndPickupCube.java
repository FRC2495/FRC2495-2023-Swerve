...
public class StartingPositionFiveOneCubeAndLeaveCommunityAndPickupCube extends SequentialCommandGroup {
    ...
    public StartingPositionFiveOneCubeAndLeaveCommunityAndPickupCube(RobotContainer container, Elevator elevator, Drawer drawer, Roller roller, Neck neck, Mouth mouth){

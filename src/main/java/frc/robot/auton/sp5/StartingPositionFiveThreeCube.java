...
public class StartingPositionFiveThreeCube extends SequentialCommandGroup {

    public StartingPositionFiveThreeCube(RobotContainer container, Elevator elevator, Drawer drawer, Roller roller, Neck neck, Mouth mouth){

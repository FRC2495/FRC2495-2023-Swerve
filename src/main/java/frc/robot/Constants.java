...
public final class Constants {
	...
	public static final class SwerveModuleConstants {
		...
		public static final double DRIVING_ENCODER_POSITION_FACTOR_METERS = (WHEEL_DIAMETER_METERS * Math.PI) / DRIVING_MOTOR_REDUCTION; // meters
		public static final double DRIVING_ENCODER_VELOCITY_FACTOR_METERS_PER_SECOND = ((WHEEL_DIAMETER_METERS * Math.PI) / DRIVING_MOTOR_REDUCTION) / 60.0; // meters per second
		...
		public static final double TURNING_ENCODER_POSITION_FACTOR_RADIANS = (2 * Math.PI) / TURNING_MOTOR_REDUCTION ; // radians - 
		public static final double TURNING_ENCODER_VELOCITY_FACTOR_RADIANS_PER_SECOND = (2 * Math.PI) / TURNING_MOTOR_REDUCTION / 60.0; // radians per second
